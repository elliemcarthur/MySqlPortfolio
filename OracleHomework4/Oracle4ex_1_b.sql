insert into students(First_Name,Last_Name,E_Mail,Address ,State,Pin ,
Phone_No ,S_ID ,Date_Of_Birth ,Qualification ,Percent_10 ,Date_Of_Passing_12 ,Subjects )
values ('Ranjit', 'Chatterjee', 'r_chatt@aaa.com', '2/10 ashok vihar', 'west bengal',
700101, 9876578901, 'S1001', '1980-04-22',
'BE', 70, 69, 2002-03-30, 'Mechanical Engg.'),
('Kaushik','Bhatterjee','kaushik@bb.com','block A gagan vihar','west bengal',
700096,9812345643,'S1002','1980-08-10','BE',65,72,'2002-04-30','Civil Engg'),
('Kunal','Ghosh','Kunal@gmail.com','1A Shivam Apt','west bengal',700096,
9678430987,'S1003','1979-12-12','BE',77,74,'1979-12-12','Mechanical Engg.'),
('Pradeep','R','Pradeep@gmail.com','2B Trinity towers','west bengal',700107,
9234540987,'S1004','1981-09-22','BE',78,70,'1981-09-22','Electrical Engg'),
('Rakhi','Mukherjee','Rakhi@gmail.com','8/12c ashoka','west bengal',700109,9980768543,
'S1005','1981-05-03','BE',80,82,'1981-05-03','Electrical Engg.'),
('Sekhar','Rao','s_rao@gmail.com','22/10 A Vishal Apt','west bengal',
700109,null,'S1006','1981-05-03','BE',75,80,'2003-06-13','Electrical Engg.');
